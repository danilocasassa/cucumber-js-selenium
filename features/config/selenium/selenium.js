  ...
  getOptionsBrowser() {
    switch (process.env.BROWSER) {
      case "chrome":
        ...
        if (!process.argv.includes("--headed")) chromOpt.addArguments("headless");
        return chromOpt;
      case "firefox":
        ...
        foxOpt.setUserPreferences({ credential_enable_service: false });
        if (!process.argv.includes("--headed")) foxOpt.addArguments("headless");
        return foxOpt;
      default:
        throw new Error(
